...
//  HotelListing
//
//  Created by Varun Kumar on 06/01/21.
//
...
extension DropDown: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return (dropDownProtocol?.numberOfRows(dropDownIdentifier: self.dropDownIdentifier) ?? 0)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        dropDownProtocol?.getDataToDropDown(cell: cell, indexPos: indexPath.row, dropDownIdentifier: self.dropDownIdentifier)
        
        return cell
    }
    
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        dropDownProtocol?.selectItemInDropDown(indexPos: indexPath.row, dropDownIdentifier: self.dropDownIdentifier)
    }
